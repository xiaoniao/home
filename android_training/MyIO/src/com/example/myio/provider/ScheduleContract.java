package com.example.myio.provider;
...
import com.example.myio.util.ParserUtils;

/**
 * 
 * ScheduleContract和ScheduleProvider类相关联
 * 
 * 除非另外说明，基于时间的单位都是毫秒因为时代和这样可以个currentTimeMillis比较
 * 
 * ContentProvider假设Uri'使用字符串而不是数值,因为数值容易在同步过程中混乱
 * 
 */
public class ScheduleContract {
    ...
    // ____________________________________________接口部分(字段)__________________________________________________//

    public interface SyncColumns {
        String UPDATED = "updated"; // Last time this entry was updated or synchronized. 上次同步的时间
    }

    interface BlocksColumns {
        String BLOCK_ID       = "block_id";      // Unique string identifying this block of time. 阻塞时间的id
        String BLOCK_TITLE    = "block_title";   // Title describing this block of time.
        String BLOCK_START    = "block_start";   // Time when this block starts.
        String BLOCK_END      = "block_end";     // Time when this block ends.
        String BLOCK_TYPE     = "block_type";    // Type describing this block.
        String BLOCK_SUBTITLE = "block_subtitle"; // Extra subtitle for the block.
    }

    interface TagsColumns {
        String TAG_ID                = "tag_id";               // Unique string identifying this tag. For example,
                                                                // "TOPIC_ANDROID", "TYPE_CODELAB"
        String TAG_CATEGORY          = "tag_category";         // Tag category. For example, the tags that identify
                                                                // what topic a session pertains to might belong to the
                                                                // "TOPIC" category; the tags that identify what type a
                                                                // session is (codelab, office hours, etc) might belong
                                                                // to the "TYPE" category.
        String TAG_NAME              = "tag_name";             // Tag name. For example, "Android"
        String TAG_ORDER_IN_CATEGORY = "tag_order_in_category"; // Tag's order in its category (for sorting).
        String TAG_COLOR             = "tag_color";            // Tag's color, in integer format.
        String TAG_ABSTRACT          = "tag_abstract";         // Tag abstract. Short summary describing tag.
    }

    interface RoomsColumns {
        String ROOM_ID    = "room_id";   // Unique string identifying this room.
        String ROOM_NAME  = "room_name"; // Name describing this room.
        String ROOM_FLOOR = "room_floor"; // Building floor this room exists on.
    }

    interface MyScheduleColumns {
        String SESSION_ID               = SessionsColumns.SESSION_ID;
        String MY_SCHEDULE_ACCOUNT_NAME = "account_name";            // Account name for which the session is starred
                                                                      // (in my schedule)
        String MY_SCHEDULE_IN_SCHEDULE  = "in_schedule";             // Indicate if last operation was "add" (true) or
                                                                      // "remove" (false). Since uniqueness is given by
                                                                      // seesion_id+account_name, this field can be used
                                                                      // as a way to find removals and sync them with
                                                                      // the cloud

        String MY_SCHEDULE_DIRTY_FLAG   = "dirty";                   // Flag to indicate if the corresponding
                                                                      // in_my_schedule item needs to be synced
    }

    interface SessionsColumns {
        String SESSION_ID              = "session_id";             // Unique string identifying this session.
        String SESSION_LEVEL           = "session_level";          // Difficulty level of the session.
        String SESSION_START           = "session_start";          // Start time of this track.
        String SESSION_END             = "session_end";            // End time of this track.
        String SESSION_TITLE           = "session_title";          // Title describing this track.
        String SESSION_ABSTRACT        = "session_abstract";       // Body of text explaining this session in detail.
        String SESSION_REQUIREMENTS    = "session_requirements";   // Requirements that attendees should meet.
        String SESSION_KEYWORDS        = "session_keywords";       // Kewords/tags for this session.
        String SESSION_HASHTAG         = "session_hashtag";        // Hashtag for this session.
        String SESSION_URL             = "session_url";            // Full URL to session online.
        String SESSION_YOUTUBE_URL     = "session_youtube_url";    // Full URL to YouTube.
        String SESSION_PDF_URL         = "session_pdf_url";        // Full URL to PDF.
        String SESSION_NOTES_URL       = "session_notes_url";      // Full URL to official session notes.
        String SESSION_IN_MY_SCHEDULE  = "session_in_my_schedule"; // User-specific flag indicating starred status.
        String SESSION_CAL_EVENT_ID    = "session_cal_event_id";   // Key for session Calendar event. (Used in ICS or
                                                                    // above)
        String SESSION_LIVESTREAM_URL  = "session_livestream_url"; // The YouTube live stream URL.
        String SESSION_MODERATOR_URL   = "session_moderator_url";  // The Moderator URL.
        String SESSION_TAGS            = "session_tags";           // The set of tags the session has. This is a
                                                                    // comma-separated list of tags.
        String SESSION_SPEAKER_NAMES   = "session_speaker_names";  // The names of the speakers on this session,
                                                                    // formatted for display.
        String SESSION_GROUPING_ORDER  = "session_grouping_order"; // The order (for sorting) of this session's type.
        String SESSION_IMPORT_HASHCODE = "session_import_hashcode"; // The hashcode of the data used to create this
                                                                    // record.
        String SESSION_MAIN_TAG        = "session_main_tag";       // The session's main tag.
        String SESSION_COLOR           = "session_color";          // The session's branding color
        String SESSION_CAPTIONS_URL    = "session_captions_url";   // The session's captions URL (for livestreamed
                                                                    // sessions).
        String SESSION_INTERVAL_COUNT  = "session_interval_count"; // The session interval when using the interval
                                                                    // counter query.
        String SESSION_PHOTO_URL       = "session_photo_url";      // The session's photo URL.
        String SESSION_RELATED_CONTENT = "session_related_content"; // The session's related content (videos and call to
                                                                    // action links).
    }

    interface SpeakersColumns {
        String SPEAKER_ID              = "speaker_id";             // Unique string identifying this speaker.
        String SPEAKER_NAME            = "speaker_name";           // Name of this speaker.
        String SPEAKER_IMAGE_URL       = "speaker_image_url";      // Profile photo of this speaker.
        String SPEAKER_COMPANY         = "speaker_company";        // Company this speaker works for.
        String SPEAKER_ABSTRACT        = "speaker_abstract";       // Body of text describing this speaker in detail.
        String SPEAKER_URL             = "speaker_url";            // Full URL to the speaker's profile.
        String SPEAKER_IMPORT_HASHCODE = "speaker_import_hashcode"; // The hashcode of the data used to create this
                                                                    // record.
    }

    interface AnnouncementsColumns {
        String ANNOUNCEMENT_ID            = "announcement_id";           // Unique string identifying this announcment.
        String ANNOUNCEMENT_TITLE         = "announcement_title";        // Title of the announcement.
        String ANNOUNCEMENT_ACTIVITY_JSON = "announcement_activity_json"; // Google+ activity JSON for the announcement.
        String ANNOUNCEMENT_URL           = "announcement_url";          // Full URL for the announcement.
        String ANNOUNCEMENT_DATE          = "announcement_date";         // Date of the announcement.
    }

    interface MapMarkerColumns {
        String MARKER_ID        = "map_marker_id";       // Unique string identifying this marker.
        String MARKER_TYPE      = "map_marker_type";     // Type of marker.
        String MARKER_LATITUDE  = "map_marker_latitude"; // Latitudinal position of marker.
        String MARKER_LONGITUDE = "map_marker_longitude"; // Longitudinal position of marker.
        String MARKER_LABEL     = "map_marker_label";    // Label (title) for this marker.
        String MARKER_FLOOR     = "map_marker_floor";    // Building floor this marker is on.
    }
    ...
    interface MapTileColumns {
        String TILE_FLOOR = "map_tile_floor"; // Floor
        String TILE_FILE  = "map_tile_file"; // Filename
        String TILE_URL   = "map_tile_url";  // Url
    }

    // 专家
    interface ExpertsColumns {
        String EXPERT_ID              = "expert_id";             // Unique string identifying this expert.
        String EXPERT_NAME            = "expert_name";           // Name of this expert.
        String EXPERT_IMAGE_URL       = "expert_image_url";      // Profile photo of this expert.
        String EXPERT_TITLE           = "expert_title";          // Title of this expert.
        String EXPERT_ABSTRACT        = "expert_abstract";       // Body of text describing this expert in detail.
        String EXPERT_URL             = "expert_url";            // Full URL to the expert's profile.
        String EXPERT_COUNTRY         = "expert_country";        // Country code of this expert.
        String EXPERT_CITY            = "expert_city";           // City of this expert.
        String EXPERT_ATTENDING       = "expert_attending";      // Whether the expert is attending the I/O this year.
        String EXPERT_IMPORT_HASHCODE = "expert_import_hashcode"; // The hashcode of the data used to create this
                                                                  // record.
    }

    // 合作伙伴
    interface PartnersColumns {
        String PARTNER_ID          = "partner_id";         // Unique string identifying this partner.
        String PARTNER_NAME        = "partner_name";       // Name of this partner.
        String PARTNER_DESC        = "partner_desc";       // Description of this partner.
        String PARTNER_WEBSITE_URL = "partner_website_url"; // Website URL for this partner.
        String PARTNER_LOGO_URL    = "partner_logo_url";   // Logo URL for this partner.
    }

    interface HashtagColumns {
        String HASHTAG_NAME        = "hashtag_name";       // Hashtags
        String HASHTAG_DESCRIPTION = "hashtag_description"; // Description about this hashtag
        String HASHTAG_COLOR       = "hashtag_color";      // Text color for this hashtag
        String HASHTAG_ORDER       = "hashtag_order";      // Ordering of this hashtag
    }

    interface PeopleIveMetColumns {
        String PERSON_ID        = "person_id";       // Google+ ID of the person
        String PERSON_TIMESTAMP = "person_timestamp"; // Time when the badge of this person was scanned
        String PERSON_NAME      = "person_name";     // Name of the person
        String PERSON_IMAGE_URL = "person_image_url"; // URL of profile icon of this person
        String PERSON_NOTE      = "person_note";     // Note about this person
    }

    interface VideoColumns {
        String VIDEO_ID              = "video_id";             // Unique string identifying this video.
        String VIDEO_YEAR            = "video_year";           // Year of the video (e.g. 2014, 2013, ...).
        String VIDEO_TITLE           = "video_title";          // Title of the video.
        String VIDEO_DESC            = "video_desc";           // Description of the video.
        String VIDEO_VID             = "video_vid";            // Youtube video ID (just the alphanumeric string, not
                                                                // the whole URL).
        String VIDEO_TOPIC           = "video_topic";          // Topic (e.g. "Android").
        String VIDEO_SPEAKERS        = "video_speakers";       // Speaker(s) (e.g. "Lauren Ipsum").
        String VIDEO_THUMBNAIL_URL   = "video_thumbnail_url";  // Thumbnail url.
        String VIDEO_IMPORT_HASHCODE = "video_import_hashcode"; // Import hashcode
    }
    ...
    public static final String[] TOP_LEVEL_PATHS         = {PATH_BLOCKS, PATH_TAGS, PATH_ROOMS, PATH_SESSIONS,
            PATH_FEEDBACK, PATH_MY_SCHEDULE, PATH_SPEAKERS, PATH_ANNOUNCEMENTS, PATH_MAP_MARKERS, PATH_MAP_FLOOR,
            PATH_MAP_MARKERS, PATH_MAP_TILES, PATH_HASHTAGS, PATH_VIDEOS, PATH_EXPERTS, PATH_PARTNERS,
            PATH_PEOPLE_IVE_MET                          };

    public static final String[] USER_DATA_RELATED_PATHS = {PATH_SESSIONS, PATH_MY_SCHEDULE};

    // __________________________________________________类_____________________________________________________ //

    /**
     * Blocks are generic timeslots. 继承上面的接口
     */
    public static class Blocks implements BlocksColumns, BaseColumns {
        ...
        /** "ORDER BY" clauses. */
        public static final String DEFAULT_SORT      = BlocksColumns.BLOCK_START + " ASC, " + BlocksColumns.BLOCK_END
                                                             + " ASC";
        ...
        /**
         * Generate a {@link #BLOCK_ID} that will always match the requested {@link Blocks} details.
         * 
    ...
    /**
     * Tags represent Session classifications. A session can have many tags. Tags can indicate, for example, what
     * product a session pertains to (Android, Chrome, ...), what type of session it is (session, codelab, office hours,
     * ...) and what overall event theme it falls under (Design, Develop, Distribute), amongst others.
     */
    ...
    /**
     * MySchedule represent the sessions that the user has starred/added to the "my schedule". Each row of MySchedule
     * represents one session in one account's my schedule.
     */
    public static class MySchedule implements MyScheduleColumns, BaseColumns {
        public static final Uri    CONTENT_URI       = BASE_CONTENT_URI.buildUpon().appendPath(PATH_MY_SCHEDULE)
                                                             .build();
    ...
    public static class Rooms implements RoomsColumns, BaseColumns {
        ...
        /** Default "ORDER BY" clause. */
        public static final String DEFAULT_SORT      = RoomsColumns.ROOM_FLOOR + " ASC, " + RoomsColumns.ROOM_NAME
                                                             + " COLLATE NOCASE ASC";
        ...
        /**
         * Build {@link Uri} that references any {@link Sessions} associated with the requested {@link #ROOM_ID}.
         */
    ...
    /**
     * Each session has zero or more {@link Tags}, a {@link Rooms}, zero or more {@link Speakers}.
     */
    public static class Sessions implements SessionsColumns, RoomsColumns, SyncColumns, BaseColumns {
        ...
        public static final Uri    CONTENT_MY_SCHEDULE_URI             = CONTENT_URI.buildUpon()
        ...
        public static final String LIVESTREAM_SELECTION                = SESSION_LIVESTREAM_URL + " is not null AND "
        ...
        /**
         * Build {@link Uri} that references any {@link Speakers} associated with the requested {@link #SESSION_ID}.
         */
        ...
        /**
         * Build {@link Uri} that references any {@link Tags} associated with the requested {@link #SESSION_ID}.
         */
        ...
        /**
         * Build {@link Uri} that references sessions that match the query. The query can be multiple words separated
         * with spaces.
         *
        ...
        public static boolean isUnscheduledSessionsInInterval(Uri uri) {
            return uri != null
                    && uri.toString().startsWith(CONTENT_URI.buildUpon().appendPath(PATH_UNSCHEDULED).toString());
        }
    ...
    public static class Speakers implements SpeakersColumns, SyncColumns, BaseColumns {
        ...
        /**
         * Build {@link Uri} that references any {@link Sessions} associated with the requested {@link #SPEAKER_ID}.
         */
    ...
    public static class Announcements implements AnnouncementsColumns, BaseColumns {
        public static final Uri    CONTENT_URI       = BASE_CONTENT_URI.buildUpon().appendPath(PATH_ANNOUNCEMENTS)
                                                             .build();
    ...
    public static class MapMarkers implements MapMarkerColumns, BaseColumns {
        public static final Uri    CONTENT_URI       = BASE_CONTENT_URI.buildUpon().appendPath(PATH_MAP_MARKERS)
                                                             .build();
        ...
        /** Default "ORDER BY" clause. */
        public static final String DEFAULT_SORT      = MapMarkerColumns.MARKER_FLOOR + " ASC, "
                                                             + MapMarkerColumns.MARKER_ID + " ASC";
    ...
    public static class Videos implements VideoColumns, BaseColumns {
        ...
        public static final String DEFAULT_SORT      = VideoColumns.VIDEO_YEAR + " DESC, " + VideoColumns.VIDEO_TOPIC
                                                             + " ASC, " + VideoColumns.VIDEO_TITLE + " ASC";
    ...
    /**
     * Each record of PeopleIveMet is collected by scanning their badges. This model is independent from other models.
     */
    public static class PeopleIveMet implements PeopleIveMetColumns, BaseColumns {
        public static final Uri    CONTENT_URI       = BASE_CONTENT_URI.buildUpon().appendPath(PATH_PEOPLE_IVE_MET)
                                                             .build();
    ...
    // __________________________________________类结束_________________________________________________//
    ...
    /**
     * Adds an account override parameter to the URI. The override parameter instructs the Content Provider to ignore
     * the currently logged in account and use the provided account when fetching account-specific data (such as
     * sessions in My Schedule).
     *
     */
    ...
    private ScheduleContract() {} // 私有构造方法，放置被实例化
}
