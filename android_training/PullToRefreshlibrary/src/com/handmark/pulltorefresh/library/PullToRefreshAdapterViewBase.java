...
// PullToRefresh适配器? 继承了PullToRefreshBase类，实现了OnScrollListener接口
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    public PullToRefreshAdapterViewBase(Context context) {
        super(context);
        mRefreshableView.setOnScrollListener(this); // 设置滚动监听
    }
     ...
     */
    public boolean getShowIndicator() { // 返回 当处于下拉刷新的状态下，indicator是否可见
    ...
    public void setAdapter(ListAdapter adapter) {
        // 给真正的View设置适配器
        ((AdapterView<ListAdapter>)mRefreshableView).setAdapter(adapter); // mRefreshableView 父类中对象
    }
     ...
     */
    public final void setEmptyView(View newEmptyView) { // 设置emptyView
