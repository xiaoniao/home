...
public class PhotoTask implements TaskRunnableDownloadMethods, TaskRunnableDecodeMethods {
    ...
    PhotoTask() {
        ...
        sPhotoManager     =  PhotoManager.getInstance();          // 获得PhotoManager实例
    }
    ...
    public void handleDecodeState(int state) {
        ...
        switch (state) {
            ...
            case PhotoDecodeRunnable.DECODE_STATE_COMPLETED: // 解析完成

                outState = PhotoManager.TASK_COMPLETE;

                break;
            case PhotoDecodeRunnable.DECODE_STATE_FAILED:    // 解析失败
            ...
            default:
                ...
                outState = PhotoManager.DECODE_STARTED;      // 解析开始
