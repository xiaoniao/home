...
public final class PullToRefreshListActivity extends ListActivity {
    ...
    static final int              MENU_MANUAL_REFRESH = 0; // 菜单
    static final int              MENU_DISABLE_SCROLL = 1; // 菜单
    static final int              MENU_SET_MODE       = 2; // 菜单
    static final int              MENU_DEMO           = 3; // 菜单

    private LinkedList<String>    mListItems;             // 数据源
    private PullToRefreshListView mPullRefreshListView;   // 自定义ListView
