...
/**
 * 实现自定义的HttpStack接口，这个HurlStack是基于HttpURLConnection实现的
 */
public class HurlStack implements HttpStack {
    ...
    public interface UrlRewriter {
        /**
         * 返回一个URL而不是给定的那个URL（是经过转换的？），如果是null代表url没有被使用过？
         * 
         * 过滤重复url？
         */
    ...
    /** 构造方法 **/
    public HurlStack(UrlRewriter urlRewriter) { // urlRewriter用于请求的url
        this(urlRewriter, null);
    }

    /** 构造方法 **/
    public HurlStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) { // 用于请求的url、sslSocketFactory用于HTTPS请求
